...
const ALL_VENDORS = [
  ...
  // Vendors 5-30 with basic details
  ...Array.from({ length: 26 }, (_, i) => {
    const id = String(i + 5);
    const categories = ['Hair & Beauty', 'Food & Catering', 'Fashion & Clothing', 'Tech Support', 'Health & Wellness', 'Education & Training', 'Home Services', 'Event Planning'];
    ...
    return {
      ...
      location: 'London, UK',
      phone: '+44 20 1234 5678',
      email: `vendor${id}@allyn.co.uk`,
      image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=800&h=400&fit=crop',
      rating: 4.5,
      reviewCount: 50,
      verified: true,
      bio: `Professional ${category} services. Contact us for bookings and inquiries.`,
      services: [
        { id: '1', name: 'Standard Service', description: 'Professional service delivery', price: 60, duration: '1-2 hours' },
        { id: '2', name: 'Premium Service', description: 'Enhanced service package', price: 120, duration: '2-3 hours' },
      ],
      reviews: [
        { id: '1', author: 'Customer', rating: 5, date: '1 week ago', text: 'Great service!' },
      ],
      availability: {
        monday: ['10:00', '14:00', '16:00'],
        tuesday: ['10:00', '14:00', '16:00'],
